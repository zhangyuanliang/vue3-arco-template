...
import { RoleManagementRecord, RoleManagementParams } from '@/api/role-management'
import { queryUserDetailList } from '@/api/user-management'
import { Pagination } from '@/types/global'
import { roleDetailColumnData } from './data'
...
const detailModalColumns = reactive<TableColumnData[]>(roleDetailColumnData)
const detailModalData = ref<RoleManagementRecord[]>([])
...
const fetchUserDetailData = async (params: RoleManagementParams = { current: 1, pageSize: 20 }) => {
  setLoading(true)
  try {
